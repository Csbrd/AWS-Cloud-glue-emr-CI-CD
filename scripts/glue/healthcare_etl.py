...
normalized_df = (
    filtered_df
    .withColumn("healthcare_id",      F.col("healthcare_id").cast(StringType()))
    ...
    .withColumn("treatment_code",     F.col("treatment_code").cast(StringType()))
    .withColumn("treatment_amount",   F.col("treatment_amount").cast(LongType()))
)
